...
public final class ApiRequest {
    ...
    private final String URL_POKEMON = "https://pokebuildapi.fr/api/v1/pokemon";
    private final String URL_TYPES = "https://pokebuildapi.fr/api/v1/types";
    ...
    public void fetchPokemons() {
        try {
            ...
            URL url = new URL(URL_POKEMON + "/limit/" + limit);
